...
/**
 * Filter that intercepts incoming HTTP requests, extracts the JWT from the Authorization header,
 * validates the token, and sets the Spring Security {@link org.springframework.security.core.Authentication}
